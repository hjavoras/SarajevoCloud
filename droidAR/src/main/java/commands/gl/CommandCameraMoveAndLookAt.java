...
public class CommandCameraMoveAndLookAt extends UndoableCommand {
    ...
    /**
     * @param targetCamera
     * @param cameraPos      the new position of the targetCamera
     * @param cameraRotation the new rotation of the targetCamera. have to be angles (like
     *                       new Vec(-90,0,180) which would be looking at the horizon in
     *                       south direction)
     * @param cameraOffset   the new offset of the targetCamera. (0,0,2) would mean the
    ...
    /**
     * @param targetCamera
     * @param cameraPos    the position where to move the camera to
     * @param targetPos    the position the camera should look at
     */
    public CommandCameraMoveAndLookAt(GLCamera targetCamera, Vec cameraPos,
                                      Vec targetPos) {
        myTargetCamera = targetCamera;
