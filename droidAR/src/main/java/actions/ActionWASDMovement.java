...
public class ActionWASDMovement extends Action {
    ...
    /**
     * @param camera
     * @param xReduction redutcion in x (W or S key) direction. Higher means slower.
     *                   Try 25f
     * @param yReduction redutcion in y (A or D key) direction. Higher means slower.
     *                   Try 50f
     * @param maxSpeed   maximum movementSpeed. Try 20f
     */
