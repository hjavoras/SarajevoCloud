...
public abstract class ActionUseCameraAngles extends Action {
     ...
     * called.
     *
     * @param threshold 1 means update on every event 10 means update every 10 events.
     *                  default is 10
     */
     ...
     *
     * @param pitchAngle 0 means the car drives straight forward, positive values (0 to
     ...
     *
     * @param rollAngle from 0 to 360. 0 means the camera targets the ground, 180 the
     *                  camera looks into the sky
     */
    public abstract void updateRoll(float rollAngle);

    /**
     * @param azimuth 0=north 90=east 180=south 270=west
     */
