...
public abstract class ActionUseCameraAngles2 implements
    ...
    /**
     * @param pitch          pitch is the rotation around the x axis. when the device would
     ...
     * @param roll           the roll is the rotation around the y axis. if the device
     ...
     * @param compassAzimuth 0=north 90=east 180=south 270=west
     */
