...
public abstract class ActionWaitForAccuracy2 extends Action {
     ...
     * @param maxPosUpdateCount The max number of update events before the position should be
    ...
    /**
     * @param location The {@link Location} object that was accurate enough
     * @param a        the {@link ActionWaitForAccuracy2} object which can be used to
