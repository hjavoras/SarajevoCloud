...
public interface UiDecorator {
    ...
    /**
     * @param context
     * @param targetView The view that will be decorated
     * @param level      the deep in the UI tree, normally pass
     ...
     * @param type       The type of the view (e.g. {@link UiDecorator#TYPE_BUTTON} if
