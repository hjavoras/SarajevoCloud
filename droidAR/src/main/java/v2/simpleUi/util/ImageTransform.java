...
public class ImageTransform {
    ...
    /**
     * @param bitmap the source
     * @param factor should be between 2f (very visible round corners) and 20f
     ...
     *
     * @param resources get the ressources object e.g. via context.getRessources or
     *                  view.getRessources
     * @param sizeInDip
     * @return
     */
     ...
     * @param bitmap
     * @param angle
     * @param smoothingFactor try 1.5f; (1 would be no smoothing at all)
     * @return
     */
     ...
     * @param sourceBitmap
     * @param resultBitmap
     * @param filterKernel   has to be a 3x3 matrix so float[9]. The kernal which will keep
    ...
    /**
     * @param targetBitmap
     * @param type         1 is Green-Blue, 2 is Red-Blue, 3 is Red - Green
     */
