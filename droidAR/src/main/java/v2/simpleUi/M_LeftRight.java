...
public class M_LeftRight implements ModifierInterface, UiDecoratable {
    ...
    /**
     * @param left
     * @param leftWeigth  if the left view should be 3 times as big as the rigth one
     *                    pass 3 here
     * @param right
     * @param rigthWeigth if the left view should be 3 times as big as the rigth one
     *                    pass 1 here
     */
