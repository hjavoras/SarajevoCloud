...
public class PhoneGestureSensor implements SensorEventListener {
    ...
    public static class Builder {
         ...
         *
         * @param context The context in which to run the sensor.
         */
         ...
         * given threshold.
         *
         * @param confidence The minimal needed confidence for a gesture to be
         *                   detected.
         * @return The builder instance for method chaining.
         */
         ...
         * whenever a sensor event occurs.
         *
         * @param logMask A bitmask specifying the messages to log. See
     ...
     *
     * @param context The application context in which to run.
     */
     ...
     *
     * @param phoneGesture The gesture that has been detected.
     */
