...
public class GLCamera implements Updateable, HasDebugInformation, Renderable,
    ...
    /**
     * @param rayPosition  the vector where the ray pos will be stored in, so pass a
     ...
     * @param rayDirection the vector where the ray direction will be stored in, so pass
     *                     a vector here that can be overwritten (don't pass null!)
     * @param x            the horizontal screen-coordinates (from 0 to screen-width)
     * @param y            the vertical screen-coordinates (from 0 to screen-height).
     ...
     * out of the camera.
     *
     * @param rayPos here the rayPos will be stored, pass a new float[4]. The
     *               result will contain {@link GLCamera#myPosition} so you dont
     *               need to add it manually! Can be NULL if you only need the
     *               ray-direction
     * @param rayDir here the rayDir will be stored, pass a new float[4]
     * @return
     */
     ...
     * add 90 degree.
     *
     * @param xAngle 0 means the car drives straight forward, positive values (0 to
     *               90) mean that the car turns left, negative values mean that
     *               the car turns right
     * @param yAngle 0 means the camera targets the ground, 180 the camera looks
     *               into the sky
     * @param zAngle like a compass (0=north, 90 east and so on
     */
     ...
     *
     * @param deltaX its important that this is not the absolute value. Its only
     *               the value wich will be added/subtracted to the current one
     * @param deltaY see deltaX description
     */
     ...
     *
     * @param deltaZ eg. -10 to move the camera 10 meters down
     */
    ...
    /**
     * @param resetZValueToo if you just want to reset x and y set this to false
     */
    ...
    /**
     * @param x positive means east of zero pos (longitude direction)
     * @param y positive means north of zero pos (latitude direction)
    ...
    /**
     * @param sensorInputEnabled set false tell the camera to ignore sensor input. You can
