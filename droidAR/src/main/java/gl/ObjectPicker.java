...
public class ObjectPicker {
    ...
    /**
     * @param info
     * @param prefferedColor if the object has an own color than set the key color near the
    ...
    /**
     * @param feedbackCommand this command will be executed every time a successful click
