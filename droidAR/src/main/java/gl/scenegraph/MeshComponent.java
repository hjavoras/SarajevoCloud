...
public abstract class MeshComponent implements RenderableEntity,
    ...
    /**
     * @param selectionInterface can be the MeshComponent itself or another
    ...
    /**
     * @param c
     * @param objToInform set the {@link SelectionListener} manually (eg the parent
     *                    {@link Obj}
     */
    ...
    /**
     * @param c                 the collection to run through. Can be
     *                          {@link MeshComponent#getChildren()} for example if the child
     *                          is a collection (check via instanceof!)
     * @param classTypeToRemove The class-type (like {@link GLAnimation}.class e.g.) If an
