...
public class Vec {
    ...
    /**
     * @param x value on red axis (east direction=longitude)
     * @param y value on green axis (north direction=latitude)
     * @param z value on blue axis (sky direction=altitude=height)
     */
     ...
     * @param angleInDegree    CLOCKWISE rotation angle
     * @return
     */
    ...
    /**
     * @param vec
     * @param factor the same factor as in {@link Vec#round(float)}
     * @return
     */
    ...
    /**
     * @param factor pass 100 if you want to cut 0.12345678 to 0.12 and 1000 to cut
     *               it to 0.123
     */
     ...
     * @param target
     * @param newPos
     * @param factor should be >0 and <1
     * @return
     */
     ...
     *
     * @param from the position where you are standing
     * @param to   the position where you want to look at
     */
    ...
    /**
     * @param center
     * @param minDistance to the center
     * @param maxDistance to the center
