...
public abstract class Setup {
     ...
     * {@link LightSource}s
     *
     * @param lights add all the {@link LightSource}s you want to use to this list
     ...
     *
     * @param infoScreenData See {@link InfoScreenSettings}
     */
     ...
     *
     * @param glRenderer      here you should add your world(s)
     * @param objectFactory   you could get this object your self wherever you want by
     *                        getting the singleton-instance of {@link GLFactory}
     * @param currentPosition might be null if no position information is available!
     */
     ...
     *
     * @param eventManager
     * @param arView       The {@link CustomGLSurfaceView#addOnTouchMoveAction(Action)}
     ...
     *
     * @param updater add anything you want to update to this updater via
     ...
     *
     * @param overlayView here you have to add your created view
     * @param activity    use this as the context for new views
     */
