...
public class ActivityConnector {
    ...
    /**
     * @param o               The object which wants to pass some data
     * @param transfairObject the object to send to the activity
     ...
     * @param ActivityClassToShow the .class object of the activity to start
     * @param objectToPass        the object to pass (null if nothing should be passed)
     */
    ...
    /**
     * @param theNewActivity the newly created activity
