...
public class UpdateTimer implements Updateable {
    ...
    /**
     * @param timeTrigger      set the interval (in s) the {@link UpdateTimer} is triggered
     *                         and its command is executed. Example values: 5s; 0.5s
     * @param commandToExecute This command will be executed if the timeTrigger value is
     ...
     * @param retryTime        The time in s when the next try will happen. The default value
     *                         is 0.2s
     */
    public UpdateTimer(float timeTrigger, Command commandToExecute,
                       float retryTime) {
    ...
    /**
     * @param myTriggerValue set the interval (in s) the {@link UpdateTimer} is triggered
     *                       and its command is executed. Example values: 5s; 0.5s
     */
