...
public abstract class ProximitySensor implements Entity {
    ...
    /**
     * @param glCamera        the camera (which should be the users position)
     * @param obj             the obj where the {@link ProximitySensor} is contained in
     * @param meshComp        the {@link MeshComponent} of the obj
     * @param currentDistance the distance of the camera to the obj
     */
