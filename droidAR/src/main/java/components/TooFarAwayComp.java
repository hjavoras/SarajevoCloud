...
public abstract class TooFarAwayComp implements Entity {
     ...
     *
     * @param maxDistance
     * @param grayZoneDist has to be larger then the max. distance!
     * @param camera
     * @param updateSpeed
     */
     ...
     *
     * @param parent    Normally this will be the {@link MeshComponent} of the target
     *                  {@link Obj} and if the object does not have one it will be the
     *                  object itself
     * @param direction The direction points from the object TO the user! If a
     ...
     * direction e.g.)
     *
     * @param parent      the parent where the {@link TooFarAwayComp} was added to. Will
     *                    also be a subclass of {@link HasPosition}.
     * @param parentsMesh the {@link MeshComponent} of the parent. If it is null the
     ...
     *                        {@link Vec} to move it away from the users position and
     *                        towards the target object
     * @param grayZonePercent from 0 to 100. 0 means entered grayzone but still far away and
