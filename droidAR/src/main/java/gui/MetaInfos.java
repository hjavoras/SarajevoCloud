...
public class MetaInfos implements EditItem {
     ...
     *
     * @param selectedInfos {@link MetaInfos} with selected details or null to remove the
     *                      selection
     */
     ...
     *
     * @param textPrefix         < in the example
     * @param textPostfix        > in the example
     * @param color              red in the example
     * @param textInfixUppercase true if everything should be uppercase
     */
