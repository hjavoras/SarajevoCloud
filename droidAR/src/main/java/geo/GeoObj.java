...
public class GeoObj extends Obj implements HasDebugInformation {
     ...
     * @param longi          the longitude value (e.g. 2.294496)
     * @param alti           the altitude value in meters (eg 20 for 20m)
    ...
    /**
     * @param l if l is null the GPS coordinates will be set to 0
     * @param b if false the virtual position wont be calculated!
     */
     ...
     * camera)
     *
     * @param latitude  the latitude value (e.g. 48.858306)
     * @param longitude the longitude value (e.g. 2.294496)
     */
     ...
     * position
     *
     * @param virtualPosition the virtual position of the object in meters
     * @param zeroLocation    normally this would be the device position, but you can
     ...
     *
     * @param GPSPosition a {@link Vec} with x=Longitude, y=Latitude, z=Altitude
     */
     ...
     *
     * @param lat1 value in degree
     * @param lng1 value in degree
     * @param lat2 value in degree
     * @param lng2 value in degree
