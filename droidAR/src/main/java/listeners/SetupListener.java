...
public interface SetupListener {
    ...
    /**
     * @param msTheLastStepTook the milliseconds the last step did take to perform. This value
     *                          can be used for debugging and optimizations. It will be 0 when
     *                          the first step is done.
     * @param statusText        This is the description of the current step. It can be used to
